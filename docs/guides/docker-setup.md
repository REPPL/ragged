...
For ragged v0.1 (see `docs/development/architecture/README.md` for model selection):
```bash
...
- ragged architecture: `docs/development/architecture/README.md`
- Model selection guide: `docs/development/core-concepts/model-selection.md`
