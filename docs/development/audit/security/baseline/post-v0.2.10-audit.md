...
1. **Safe JSON Serialisation Implemented**:
   - Created `./src/utils/serialization.py` with safe JSON utilities
...
**File**: `./src/cli/commands/history.py`
...
**Files Modified**:
- Created: `./src/core/session.py` (405 lines)
- Modified: `./src/retrieval/cache.py`
...
**File**: `./src/web/api.py` (Lines 43-49)
...
**File**: `./src/web/api.py` (Lines 267-361)
...
**File**: `./src/cli/commands/exportimport.py`
...
**File Created**: `./src/utils/serialization.py` (298 lines)
...
**File Created**: `./src/core/session.py` (405 lines)
...
**Files Created**:
- `./tests/security/test_no_pickle.py` (392 lines)
- `./tests/security/test_session_isolation.py` (461 lines)
- `./tests/security/test_security_framework.py` (313 lines)
