...
**Output location:** `/docs/development/decisions/ADR-XXX-title.md`
...
**Output location:** `/docs/development/devlog/YYYY-MM-DD.md`
...
**Output location:** `/docs/implementation/plan/versions/vX.Y/README.md`
...
- **Development Guide**: [../../implementation/plan/DEVELOPMENT-GUIDE.md](../../implementation/plan/DEVELOPMENT-GUIDE.md)
- **Version Roadmap**: [../../implementation/plan/versions/](../../implementation/plan/versions/)
...
1. **Creating an ADR**: Copy `adr-template.md` → `/docs/development/decisions/ADR-XXX-title.md`
2. **Daily Devlog**: Copy `devlog-template.md` → `/docs/development/devlog/2025-11-09.md`
3. **New User Story**: Copy `user-story-template.md` → `/docs/requirements/user-stories/US-XXX-title.md`
4. **Version Summary**: Copy `version-summary-template.md` → `/docs/implementation/plan/versions/vX.Y/README.md`
5. **Time Tracking**: Copy `feature-time-log-template.md` → `/docs/development/time-logs/feature-name.md`
