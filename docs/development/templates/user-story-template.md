...
**Definition**: [Link to persona definition](../../implementation/plan/core-concepts/personal-memory-personas.md#[persona-name]-persona)
...
### Implementation
- [Link to related implementation doc](../../implementation/plan/core-concepts/[doc-name].md)
- [Link to related architecture doc](../../implementation/plan/architecture/README.md#[section])

### Architecture
- [Link to architectural decision](../../implementation/plan/architecture/README.md#[component])
- [Link to system design](../../implementation/plan/core-concepts/[doc-name].md#[section])

### Testing
- [Link to test strategy](../../implementation/plan/core-concepts/testing-strategy.md#[section])
- [Link to golden dataset](../../implementation/plan/testing/golden-dataset/)
