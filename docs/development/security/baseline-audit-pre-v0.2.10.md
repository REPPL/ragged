...
**Files Affected**:
- `[PROJECT_ROOT]/src/retrieval/incremental_index.py` (Lines 6, 280, 341)
- `[PROJECT_ROOT]/src/utils/multi_tier_cache.py` (Lines 12, 209, 264, 325)
...
**Files Affected**:
- `[PROJECT_ROOT]/src/cli/commands/history.py` (Lines 52-65, 82-95)
...
**Files Affected**:
- `[PROJECT_ROOT]/src/retrieval/cache.py` (Lines 35-297)
- `[PROJECT_ROOT]/src/utils/multi_tier_cache.py` (Lines 405-667)
...
**Files Affected**:
- `[PROJECT_ROOT]/src/web/api.py` (All endpoints, lines 99-375)
...
**Files Affected**:
- `[PROJECT_ROOT]/src/web/api.py` (Lines 43-49)
...
**Files Affected**:
- `[PROJECT_ROOT]/src/web/api.py` (Lines 267-361)
...
**Files Affected**:
- `[PROJECT_ROOT]/src/cli/commands/exportimport.py` (Lines 78-81, 204, 343)
...
**Files Affected**:
- `[PROJECT_ROOT]/src/cli/commands/history.py` (Line 95)
- `[PROJECT_ROOT]/src/retrieval/cache.py` (Lines 96, 178)
- `[PROJECT_ROOT]/src/utils/multi_tier_cache.py` (Line 83)
...
**Files Affected**:
- `[PROJECT_ROOT]/src/web/api.py` (Lines 259-264, 351-356)
...
**Files Affected**:
- `[PROJECT_ROOT]/src/storage/vector_store.py` (Lines 165-221)
...
**Files Affected**:
- `[PROJECT_ROOT]/src/web/api.py` (All endpoints)
...
**Files Affected**:
- `[PROJECT_ROOT]/src/web/gradio_ui.py` (Not examined in detail, inferred from structure)
...
**Files Affected**:
- `[PROJECT_ROOT]/src/web/api.py` (Lines 295-298)
...
**Files Affected**:
- `[PROJECT_ROOT]/src/config/settings.py` (Lines 39-40)
