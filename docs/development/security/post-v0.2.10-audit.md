...
**Files Fixed**:
- `[PROJECT_ROOT]/src/retrieval/incremental_index.py`
- `[PROJECT_ROOT]/src/utils/multi_tier_cache.py`

**Verification**:

1. **Safe JSON Serialisation Implemented**:
   - Created `[PROJECT_ROOT]/src/utils/serialization.py` with safe JSON utilities
...
**File**: `[PROJECT_ROOT]/src/cli/commands/history.py`
...
**Files Modified**:
- Created: `[PROJECT_ROOT]/src/core/session.py` (405 lines)
- Modified: `[PROJECT_ROOT]/src/retrieval/cache.py`
...
**File**: `[PROJECT_ROOT]/src/web/api.py`
...
**File**: `[PROJECT_ROOT]/src/web/api.py` (Lines 43-49)
...
**File**: `[PROJECT_ROOT]/src/web/api.py` (Lines 267-361)
...
**File**: `[PROJECT_ROOT]/src/cli/commands/exportimport.py`
...
**File Created**: `[PROJECT_ROOT]/src/utils/serialization.py` (298 lines)
...
**File Created**: `[PROJECT_ROOT]/src/core/session.py` (405 lines)
...
**Files Created**:
- `[PROJECT_ROOT]/tests/security/test_no_pickle.py` (392 lines)
- `[PROJECT_ROOT]/tests/security/test_session_isolation.py` (461 lines)
- `[PROJECT_ROOT]/tests/security/test_security_framework.py` (313 lines)
