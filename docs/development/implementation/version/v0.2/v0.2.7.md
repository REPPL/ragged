...
### 2. Folder Ingestion with Recursive Scanning ✅
...
ragged add "~/Documents/RAG--Library/Research -- Web/input/" --recursive
```
...
- HTML processing ✅
- Progress feedback ✅
- Performance (→ deferred to v0.2.9)
```
...
- **CLI Entry Point**: 586 lines → 107 lines (82% reduction)
...
- [v0.2.7 Roadmap](../../../roadmap/version/v0.2/v0.2.7/README.md) - Original plan
- [v0.2.8 Roadmap](../../../roadmap/version/v0.2/v0.2.8.md) - CLI enhancements continuation
- [CHANGELOG](../v0.5.6/CHANGELOG.md) - Official release history
