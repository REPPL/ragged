...
- **Behaviour Learning**: Automatically learn interests from query patterns
...
**Related Documentation:** CLI Enhancements Catalogue
...
- [v0.4 Planning](../../../planning/version/v0.4/) - Design goals
- [Plugin Architecture (v0.4.0)](./v0.4.0.md) - Plugin foundation
- [v0.3 Implementation](../../../implementation/version/v0.3/) - Previous version
