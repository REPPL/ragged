# v0.4.7 - Refactoring & Architecture Improvements

**Hours**: 10-12 | **Priority**: P2 - Quality | **Status**: Planned

**Dependencies**: v0.4.6 complete (Behaviour learning integrated)
...
- [v0.4.6](v0.4.6.md) - Behaviour learning (previous)
- [v0.4.8](v0.4.8.md) - Temporal memory (next)
