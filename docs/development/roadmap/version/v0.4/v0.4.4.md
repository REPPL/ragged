# v0.4.0 - Stability & Performance Enhancement

**Hours**: 15-18 | **Priority**: P1 - Quality | **Status**: Planned

**Dependencies**: v0.4.0 complete (Memory foundation)
...
- [v0.4.0](v0.4.0.md) - Memory foundation (previous)
- [v0.4.0](v0.4.0.md) - Behaviour learning (next)
