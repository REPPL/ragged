# v0.4.0 - Behaviour Learning & Personalisation

**Hours**: 35-40 | **Priority**: P0 - Core Feature | **Status**: Planned

**Dependencies**: v0.4.0 complete (Stable memory system)
...
## 🔍 LEANN Decision Point: Storage Evaluation
...
- [v0.4.0](v0.4.0.md) - Stability (previous)
- [v0.4.0](v0.4.0.md) - Refactoring (next)
- [v0.4.0](v0.4.0.md) - **LEANN backend (conditional)** - Decision made after v0.4.6
