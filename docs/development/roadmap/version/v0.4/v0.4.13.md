# v0.4.13 - Production Deployment & Documentation

**Hours**: 12-15 | **Priority**: P0 - Release | **Status**: Planned
...
**Privacy Test Suite** (see [v0.4.5/testing-scenarios.md](v0.4.5/testing-scenarios.md)):
...
Version 0.4.9 (and v0.4 series) is successful if:
...
- ✅ LEANN backend integrated (if v0.4.8 implemented) OR ChromaDB-only (if v0.4.8 skipped)
- ✅ All CLI commands functional

**Privacy** (critical validation):
- ✅ Zero network calls during memory operations (verified)
- ✅ All data in `~/.ragged/memory/` (verified)
- ✅ Persona isolation complete (verified)
- ✅ User controls functional (GDPR Articles 15, 17, 20)
- ✅ Encryption at rest validated
- ✅ No privacy regressions from v0.4.3 audit
...
### Pre-Release
- [ ] All v0.4.0-v0.4.8 features merged (required)
...
- [ ] Privacy test suite passed (all scenarios in [v0.4.5/testing-scenarios.md](v0.4.5/testing-scenarios.md))
...
- [ ] Privacy documentation complete ([v0.4.5/privacy-framework.md](v0.4.5/privacy-framework.md))
...
- ✅ LEANN backend (97% storage savings) - **conditional** (implemented if v0.4.8 decision = "Proceed")
...
- [v0.4.3 README](v0.4.3.md) - Memory foundation implementation
- [v0.4.3 Security Audit](v0.4.5/security-audit.md) - Security requirements and validation
- [v0.4.3 Privacy Framework](v0.4.5/privacy-framework.md) - User privacy controls and GDPR compliance
- [v0.4.3 Testing Scenarios](v0.4.5/testing-scenarios.md) - **Privacy test suite** (used in v0.4.9 verification)
- [v0.4.5](v0.4.5/README.md) - Behaviour learning and LEANN decision point
