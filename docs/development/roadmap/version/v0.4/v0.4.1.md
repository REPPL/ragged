# v0.4.0 - VectorStore Abstraction & Refactoring
...
**Note**: This release refines and integrates the VectorStore interface initially designed and implemented in v0.3.7, ensuring it's production-ready for v0.4 memory features and v0.4.0 LEANN integration.
...
- [v0.4.0](v0.4.0.md) - Code quality (next)
