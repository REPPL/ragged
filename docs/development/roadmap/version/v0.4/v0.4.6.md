# v0.4.0 - Refactoring & Architecture Improvements

**Hours**: 10-12 | **Priority**: P2 - Quality | **Status**: Planned

**Dependencies**: v0.4.0 complete (Behaviour learning integrated)
...
- [v0.4.0](v0.4.0.md) - Behaviour learning (previous)
- [v0.4.0](v0.4.0.md) - Temporal memory (next)
