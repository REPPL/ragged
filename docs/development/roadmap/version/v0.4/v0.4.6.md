# v0.4.4 - Stability & Performance Enhancement

**Hours**: 15-18 | **Priority**: P1 - Quality | **Status**: Planned

**Dependencies**: v0.4.3 complete (Memory foundation)
...
- [v0.4.3 README](v0.4.3/README.md) - Memory foundation (previous)
- [v0.4.5](v0.4.5.md) - Behaviour learning (next)
