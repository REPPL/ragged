...
👁️  Watching: /Users/alice/Documents/Research
Patterns: *.pdf
...
[2024-01-15 14:30:18] ✓ Added paper_2024.pdf with 127 chunks (98% confidence)

[2024-01-15 14:35:42] Detected new file: thesis_draft.pdf
[2024-01-15 14:35:42] Processing thesis_draft.pdf...
[2024-01-15 14:35:56] ✓ Added thesis_draft.pdf with 842 chunks (95% confidence)

[2024-01-15 14:40:03] Detected modified file: paper_2024.pdf
[2024-01-15 14:40:03] Reprocessing paper_2024.pdf...
[2024-01-15 14:40:06] ✓ Updated paper_2024.pdf with 127 chunks (98% confidence)
...
✓ Watch daemon stopped (PID: 12345)
...
✓ Scheduled: weekly-quality-check
...
[1] daily-summary
    ...
    Command: template run templates/daily_summary.j2
    Status: Active
    Last run: 2024-01-15 09:00:05 (✓ Success)
    Next run: 2024-01-16 09:00:00
    Executions: 47
...
[2] weekly-quality-check
    ...
    Command: test retrieval --benchmark tests/benchmark.json
    Status: Active
    Last run: 2024-01-12 18:00:12 (✓ Success)
    Next run: 2024-01-19 18:00:00
    Executions: 12
...
✓ Disabled: weekly-quality-check

$ ragged schedule logs daily-summary --tail 50

📜 Execution Logs: daily-summary (last 50 runs)

[2024-01-15 09:00:05] ✓ Success (duration: 234ms)
[2024-01-14 09:00:03] ✓ Success (duration: 245ms)
[2024-01-13 09:00:04] ✗ Error: Template not found
[2024-01-12 09:00:06] ✓ Success (duration: 239ms)
...
```
...
```
src/cli/commands/
├── watch.py                    # Watch commands (250 lines)
│   └── class WatchManager
└── schedule.py                 # Schedule commands (300 lines)
    └── class ScheduleManager

src/automation/
├── watcher.py                  # File watching (300 lines)
│   ├── class FileWatcher
│   └── class EventHandler
├── scheduler.py                # Job scheduling (250 lines)
│   └── class JobScheduler
└── daemon.py                   # Daemon support (150 lines)
    └── class DaemonManager

data/
├── watch.db                    # Watch state database
...
### Pre-Implementation
- [ ] Create branch: `git checkout -b feature/v0.3.11-production-operations`
...
- ✅ Watch mode monitors directories reliably
- ✅ File events processed correctly
- ✅ Daemon mode operates stably
- ✅ Scheduled jobs execute on time
...
- [v0.3.0 - Automation & Templates](./v0.3.0.md) - Template integration for scheduled reports
