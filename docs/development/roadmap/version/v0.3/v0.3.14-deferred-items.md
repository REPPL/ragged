...
**Fix Strategy:**
1. Investigate actual vs expected mock behaviour (2h)
2. Update mock patterns for lazy-loaded components (2h)
3. Ensure tests reflect real behaviour (1h)
...
**From:** [Dependency Scan](../../../../guides/security/dependency-scan.md)
...
- [v0.3.4a Security Audit](../../../audit/security/baseline/v0.3.4a-security-audit.md)
- [v0.3.4b Security Audit](../../../audit/security/baseline/v0.3.4b-security-audit.md)
- [Dependency Scan](../../../../guides/security/dependency-scan.md)
