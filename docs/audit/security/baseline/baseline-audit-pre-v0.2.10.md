...
**Files Affected**:
- `./src/retrieval/incremental_index.py` (Lines 6, 280, 341)
- `./src/utils/multi_tier_cache.py` (Lines 12, 209, 264, 325)
...
**Files Affected**:
- `./src/cli/commands/history.py` (Lines 52-65, 82-95)
...
**Files Affected**:
- `./src/retrieval/cache.py` (Lines 35-297)
- `./src/utils/multi_tier_cache.py` (Lines 405-667)
...
**Files Affected**:
- `./src/web/api.py` (All endpoints, lines 99-375)
...
**Files Affected**:
- `./src/cli/commands/exportimport.py` (Lines 78-81, 204, 343)
...
**Files Affected**:
- `./src/cli/commands/history.py` (Line 95)
- `./src/retrieval/cache.py` (Lines 96, 178)
- `./src/utils/multi_tier_cache.py` (Line 83)
...
**Files Affected**:
- `./src/web/api.py` (Lines 259-264, 351-356)
...
**Files Affected**:
- `./src/storage/vector_store.py` (Lines 165-221)
...
**Files Affected**:
- `./src/web/gradio_ui.py` (Not examined in detail, inferred from structure)
...
**Files Affected**:
- `./src/config/settings.py` (Lines 39-40)
